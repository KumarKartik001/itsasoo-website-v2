            ...
            <section className="relative w-full h-[60vh] md:h-[70vh] flex items-center justify-center text-white overflow-hidden">
                ...
                >
                    <h2 className="text-4xl md:text-5xl font-extrabold leading-tight drop-shadow-xl">
                        Australia
                        <span className="text-[#e9e505]"> Finance Outsourcing Services</span>
                    </h2>
            ...
            <div className="max-w-7xl mx-auto px-6 py-16 space-y-24">
                ...
                <div className="grid md:grid-cols-2 gap-14 items-center bg-[#E3EEF3] p-10 rounded-3xl shadow-lg">
                    ...
                    <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
                        <img src="/Australia/bookkeeping.jpg" className="rounded-2xl shadow-xl object-cover w-full h-full" />
                    </motion.div>
                ...
                <div className="grid md:grid-cols-2 gap-14 items-center bg-[#93b2d4] p-10 rounded-3xl shadow-lg">
                    ...
                    {/* Image */}
                    <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
                        <img src="/Australia/financial-reporting.jpg" className="rounded-2xl shadow-xl object-cover w-full h-full" />
                    </motion.div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-14 items-center bg-[#E3EEF3] p-10 rounded-3xl shadow-lg">
                    ...
                    {/* Image */}
                    <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
                        <img src="/Australia/tax.jpg" className="rounded-2xl shadow-xl object-cover w-full h-full" />
                    </motion.div>
                ...
                <div className="grid md:grid-cols-2 gap-14 items-center bg-[#93b2d4] p-10 rounded-3xl shadow-lg">
                    ...
                    {/* Image */}
                    <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
                        <img src="/Australia/payroll.jpg" className="rounded-2xl shadow-xl object-cover w-full h-full" />
                    </motion.div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-14 items-center bg-[#E3EEF3] p-10 rounded-3xl shadow-lg">
                    ...
                    {/* Image */}
                    <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
                        <img src="/Australia/salestax.jpg" className="rounded-2xl shadow-xl object-cover w-full h-full" />
                    </motion.div>
