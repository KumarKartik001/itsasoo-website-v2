                                            ...
                                            <div className="col-span-5 px-6 flex items-center gap-4 relative">
                                                <div
                                                    className={`absolute left-0 top-1/2 -translate-y-1/2 h-12 w-1 rounded-r-full transition-all duration-300 ${isSelected
                                                        ? "bg-gradient-to-b from-cyan-400 to-blue-400 opacity-100"
                                                        : "opacity-0"
                                                        }`}
                                                />
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-white relative">
                                    {/* Divider */}
                                    <div className="hidden md:block absolute left-1/2 -translate-x-1/2 top-0 h-full w-[1px] bg-white/10"></div>
                                ...
                                <div className="mt-8 flex items-center justify-between">
                                    ...
                                    <Link
                                        href="/contact"
                                        onClick={() => setOpenRow(null)}
                                        className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-[#48C8FF] to-[#1EA4D9] text-[#001827] font-semibold shadow-md hover:scale-[1.03] transition"
                                    >
